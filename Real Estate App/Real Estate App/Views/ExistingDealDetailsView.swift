...
//        let cashOnly = Binding<Bool>(get: { deal.cashOnly }, set: { deal.cashOnly = $0; deal.cashAndFinance = !deal.cashOnly;
//            if deal.cashOnly == true {
...
//        })
//
//        let cashAndFinance = Binding<Bool>(get: { deal.cashAndFinance }, set: { deal.cashOnly = deal.cashAndFinance; deal.cashAndFinance = $0;
//            if deal.cashAndFinance == false {
//                detailVM.paymentType = "Cash Only"
//            } else {
//                detailVM.paymentType = "Cash+Finance"
//            }
